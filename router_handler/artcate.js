...
exports.getArticleCates = async (req, res) => {
    const sql = 'select * from ev_articlecate where is_delete = 0 order by id asc'
...
exports.addArticleCates = async (req, res) => {
    const sql = 'select * from ev_articlecate where name = ? or alias = ?'
    ...
    const sqlInsert = 'insert into ev_articlecate set ?'
...
exports.deleteArticleById = async (req, res) => {
    const sql = 'update ev_articlecate set is_delete = 1 where id = ?'
...
exports.getArticleCateById = async (req, res) => {
    const sql = 'select * from ev_articlecate where id = ?'
...
exports.updateCateById = async (req, res) => {
    const sql = 'select * from ev_articlecate where id != ? and (name = ? or alias = ?)'
    ...
    const sqlUpdate = 'update ev_articlecate set ? where id = ?'
